FROM clux/muslrust:1.91.1-stable AS build_base
USER root
...
FROM gcr.io/distroless/static@sha256:f2ff10a709b0fd153997059b698ada702e4870745b6077eff03a5f4850ca91b6 AS runtime
WORKDIR /runtime
