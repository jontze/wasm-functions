FROM clux/muslrust:1.93.1-stable AS build_base
USER root
...
FROM gcr.io/distroless/static@sha256:972618ca78034aaddc55864342014a96b85108c607372f7cbd0dbd1361f1d841 AS runtime
WORKDIR /runtime
