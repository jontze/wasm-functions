...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:component:wasm-function-hello:example:encoded world"]
#[doc(hidden)]
...
@\0\0s\x04\0\x0bhello-world\x01\0\x04\0%component:wasm-function-hello/example\x04\
